...
export const translations = {
  en: {
    ...
    heroSub: "Ask NyayaBot any question about the Indian Constitution, Fundamental Rights, or legal provisions — and get clear, cited answers in seconds.",
    ...
    heroChatTyping: "NyayaBot is typing",
    ...
    // Features
    featuresTag: "What NyayaBot Does",
    featuresH1: "Know the law.",
    featuresH2: "Exercise your rights.",
    featuresSub: "Three powerful capabilities, one constitutional AI. Swipe through to explore what NyayaBot does for every Indian citizen.",
    ...
    feat3Body: "Ask in Hindi or English. NyayaBot understands and responds in the language you're most comfortable with.",

    // Walkthrough
    walk1Step: "Step 01",
    walk1Headline: "Ask in plain language.",
    walk1Body: "No legal jargon needed. Type your situation the way you'd explain it to a friend. NyayaBot understands context.",
    walk2Step: "Step 02",
    walk2Headline: "Get answers with sources.",
    walk2Body: "NyayaBot cites the exact Article, Amendment, or Court ruling behind every answer. Click any citation to read the original text.",
    ...
    test1Quote: "I finally understood my tenant rights when my landlord threatened to throw me out. NyayaBot cited Article 21 and Section 9 of the Transfer of Property Act in under 10 seconds.",
    ...
    test3Quote: "We integrated NyayaBot into our rural legal aid camp. Villagers could now ask questions in Hindi and get real answers.",
    test3Name: "Advocate Santosh Kumar",
    test3Des: "Bihar State Bar Council",

    // TrustBadges
    tbWhy: "Why Trust NyayaBot",
    tbH1: "Built on constitutional truth.",
    tbH2: "Not opinions.",
    tbSub: "NyayaBot's knowledge base is trained exclusively on verified sources of Indian law:",
    ...
    ctaSub: "Start asking NyayaBot — no signup needed to try.",
    ctaP1: "Ask Your First Question →",
    ctaP2: "Access Your Rights →",
    ctaD1: "See Demo",
    ctaD2: "▶ Watch 2-min tour",
    ctaDisc1: "NyayaBot is an informational tool. It does not constitute legal advice.",
